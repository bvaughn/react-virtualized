...
import SortDirection from './../FlexTable/SortDirection'
import SortIndicator from './../FlexTable/SortIndicator'
import shallowCompare from 'react-addons-shallow-compare'
import styles from './SelectableGridComponent.example.css'

export default class SelectableGridComponentExample extends Component {
  static propTypes = {
  ...
  render () {
    ...
    return (
      <ContentBox {...props}>
        <ContentBoxHeader
          text='SelectableGridComponent'
          sourceLink='https://github.com/bvaughn/react-virtualized/blob/master/source/SelectableGridComponent/SelectableGridComponent.example.js'
          docsLink='https://github.com/bvaughn/react-virtualized/blob/master/docs/SelectableGridComponent.md'
        />
        ...
        <ContentBoxParagraph>
          ...
          This exemple includes selection on the table!
        </ContentBoxParagraph>
