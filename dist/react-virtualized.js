	   ...
	   */
                return _inherits(Grid, _Component), _createClass(Grid, [ {
                    ...
                    value: function(prevProps, prevState) {
                        ...
                        isScrolling || (scrollLeft >= 0 && scrollLeft !== prevState.scrollLeft && scrollLeft !== this.refs.scrollingContainer.scrollLeft && (this.refs.scrollingContainer.scrollLeft = scrollLeft), 
