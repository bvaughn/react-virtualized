    ...
    var win = void 0, raf = (win = "undefined" != typeof window ? window : "undefined" != typeof self ? self : {}).requestAnimationFrame || win.webkitRequestAnimationFrame || win.mozRequestAnimationFrame || win.oRequestAnimationFrame || win.msRequestAnimationFrame || function(callback) {
        ...
        return inherits(Grid, _React$PureComponent), createClass(Grid, [ {
            ...
            value: function() {
                ...
                this._scrollingContainer && (0 !== this.state.scrollLeft && this._scrollingContainer.scrollLeft !== this.state.scrollLeft && (this._scrollingContainer.scrollLeft = this.state.scrollLeft), 
                0 !== this.state.scrollTop && this._scrollingContainer.scrollTop !== this.state.scrollTop && (this._scrollingContainer.scrollTop = this.state.scrollTop));
