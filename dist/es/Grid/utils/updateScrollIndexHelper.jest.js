...
import CellSizeAndPositionManager from './CellSizeAndPositionManager'; // Default cell sizes and offsets for use in shared tests
...
export function getCellSizeAndPositionManager(_ref) {
  var _ref$cellCount = _ref.cellCount,
    ...
    estimatedCellSize =
      _ref$estimatedCellSiz === void 0 ? 10 : _ref$estimatedCellSiz;
...
describe('updateScrollIndexHelper', function() {
  function helper() {
    var _ref3 =
      ...
      previousCellsCount =
        _ref3$previousCellsCo === void 0 ? undefined : _ref3$previousCellsCo,
      _ref3$previousCellSiz = _ref3.previousCellSize,
      previousCellSize =
        _ref3$previousCellSiz === void 0 ? 10 : _ref3$previousCellSiz,
      _ref3$previousScrollT = _ref3.previousScrollToAlignment,
      previousScrollToAlignment =
        _ref3$previousScrollT === void 0 ? 'auto' : _ref3$previousScrollT,
      ...
      scrollToAlignment =
        _ref3$scrollToAlignme === void 0 ? 'auto' : _ref3$scrollToAlignme,
