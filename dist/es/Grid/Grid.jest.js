...
describe('Grid', function() {
  ...
  describe('overscanColumnCount & overscanRowCount', function() {
    ...
    it(
      'should overscan in the direction being scrolled',
      /*#__PURE__*/ (function() {
  ...
  it(
    'should pass the cellRenderer an :isScrolling flag when scrolling is in progress',
    /*#__PURE__*/ (function() {
      var _ref6 = _asyncToGenerator(
        /*#__PURE__*/ _regeneratorRuntime.mark(function _callee2(done) {
  ...
  describe('cell caching', function() {
    ...
    it(
      'should clear cache once :isScrolling is false',
      /*#__PURE__*/ (function() {
        var _ref12 = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime.mark(function _callee3(done) {
    ...
    it(
      'should clear cache once :isScrolling via props is false',
            ...
            while (1) {
              switch ((_context4.prev = _context4.next)) {
                case 0:
                  ...
                  expect(cellRenderer.mock.calls[0][0].style).toBe(
                    scrollingStyle,
                  );
    ...
    it(
      'should not trigger render by _debounceScrollEndedCallback if process slow table',
      /*#__PURE__*/ _asyncToGenerator(
              ...
              switch ((_context5.prev = _context5.next)) {
                ...
                case 17:
                  ...
                  return new Promise(function(resolve) {
                    return setTimeout(
                      resolve,
                      scrollingResetTimeInterval * 1.5,
                    );
                  });
    ...
    it(
      'should support a custom :scrollingResetTimeInterval prop',
      /*#__PURE__*/ (function() {
        var _ref18 = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime.mark(function _callee6(done) {
            var cellRendererCalls,
              scrollingResetTimeInterval,
              cellRenderer,
              props,
  ...
  describe('pure', function() {
    ...
    it(
      'should clear all but the visible rows from the style cache once :isScrolling is false',
      /*#__PURE__*/ (function() {
        var _ref24 = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime.mark(function _callee7(done) {
            var props, grid;
