...
describe('AutoSizer', function() {
  ...
  function _simulateResize() {
    _simulateResize = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime.mark(function _callee5(_ref4) {
  ...
  it(
    'should update :height after a resize event',
    /*#__PURE__*/ (function() {
  ...
  describe('onResize and (re)render', function() {
    it(
      'should trigger when size changes',
      /*#__PURE__*/ (function() {
    ...
    it(
      'should only trigger when height changes for disableWidth == true',
      /*#__PURE__*/ (function() {
    ...
    it(
      'should only trigger when width changes for disableHeight == true',
      /*#__PURE__*/ (function() {
        var _ref8 = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime.mark(function _callee4(done) {
            var onResize, ChildComponent, rendered;
