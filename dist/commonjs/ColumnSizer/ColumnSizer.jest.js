...
describe('ColumnSizer', function() {
  function getMarkup() {
    var _ref =
      ...
      columnMinWidth =
        _ref$columnMinWidth === void 0 ? undefined : _ref$columnMinWidth,
      _ref$columnMaxWidth = _ref.columnMaxWidth,
      columnMaxWidth =
        _ref$columnMaxWidth === void 0 ? undefined : _ref$columnMaxWidth,
      ...
      function(_ref3) {
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            'adjustedWidth:'
              .concat(adjustedWidth, ' columnWidth:')
              .concat(columnWidth),
          ),
        );
      },
  ...
  describe('recomputeGridSize', function() {
    function helper(updatedProps, expectedTextContent) {
      var renderedA = (0, _reactDom.findDOMNode)(
        (0, _TestUtils.render)(getMarkup()),
      );
      expect(renderedA.querySelector('.debug').textContent).toContain(
        'columnWidth:20',
      );
      var renderedB = (0, _reactDom.findDOMNode)(
        (0, _TestUtils.render)(getMarkup(updatedProps)),
      );
