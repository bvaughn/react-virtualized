    ...
    (0, _createClass2['default'])(GridExample, [
      ...
      },
      {
        ...
        value: function _getRowClassName(row) {
          return row % 2 === 0
            ? _GridExample['default'].evenRow
            : _GridExample['default'].oddRow;
        },
      },
      {
        key: '_getRowHeight',
      ...
      },
      {
        ...
        value: function _renderBodyCell(_ref5) {
          ...
          var classNames = (0, _clsx2['default'])(
            rowClass,
            _GridExample['default'].cell,
            (0, _defineProperty2['default'])(
              {},
              _GridExample['default'].centeredCell,
              columnIndex > 2,
            ),
          );
          return React.createElement(
      ...
      },
      {
        ...
        value: function _renderLeftSideCell(_ref6) {
          ...
          var classNames = (0, _clsx2['default'])(
            _GridExample['default'].cell,
            _GridExample['default'].letterCell,
          ); // Don't modify styles.
