...
var _ScalingCellSizeAndPositionManager = require('./ScalingCellSizeAndPositionManager');
...
describe('ScalingCellSizeAndPositionManager', function () {
  function init() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        cellCount = _ref$cellCount === undefined ? 10 : _ref$cellCount,
        ...
        maxScrollSize = _ref$maxScrollSize === undefined ? 50 : _ref$maxScrollSize;

    var cellSizeAndPositionManager = new _ScalingCellSizeAndPositionManager2.default({
      cellCount: cellCount,
  ...
  describe('_getOffsetPercentage', function () {
    it('should return the correct offset fraction', function () {
      var expectations = [{ offset: 0, expectedOffsetPercentage: 0 }, { offset: 35, expectedOffsetPercentage: 0.5 }, { offset: 70, expectedOffsetPercentage: 1 }];
      var instance = init();
  ...
  describe('getOffsetAdjustment', function () {
    ...
    it('should properly scale an offset at the beginning, middle, and end of the list', function () {
      var offsetsAndExpectedAdjustements = [{ offset: 0, expectedAdjustment: 0 }, { offset: 10, expectedAdjustment: -25 }, { offset: 20, expectedAdjustment: -50 }];
      var instance = init();
  ...
  describe('getUpdatedOffsetForIndex', function () {
    it('should scroll to a cell before the current range', function () {
      var data = [{ targetIndex: 0, expectedOffset: 0 }, { targetIndex: 1, expectedOffset: 3 }, // (unsafe: 10)
      { targetIndex: 2, expectedOffset: 6 }];
      var instance = init();
    ...
    it('should scroll to a cell after the current range', function () {
      var data = [{ targetIndex: 7, expectedOffset: 14 }, // (unsafe: 50)
      { targetIndex: 9, expectedOffset: 20 }];
      var instance = init();
      data.forEach(function (datum) {
        expect(instance.getUpdatedOffsetForIndex({
          containerSize: 30,
