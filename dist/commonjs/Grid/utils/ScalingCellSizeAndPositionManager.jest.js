...
var _ScalingCellSizeAndPositionManager = _interopRequireDefault(
  require('./ScalingCellSizeAndPositionManager'),
);
...
describe('ScalingCellSizeAndPositionManager', function() {
  function init() {
    ...
    var cellSizeAndPositionManager = new _ScalingCellSizeAndPositionManager[
      'default'
    ]({
      cellCount: cellCount,
  ...
  describe('getOffsetAdjustment', function() {
    ...
    it('should properly scale an offset at the beginning, middle, and end of the list', function() {
      ...
      var instance = init();
      offsetsAndExpectedAdjustements.forEach(function(
        offsetAndExpectedAdjustement,
      ) {
        expect(
          instance.getOffsetAdjustment({
            containerSize: 30,
