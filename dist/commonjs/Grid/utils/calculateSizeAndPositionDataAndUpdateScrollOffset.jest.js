...
var _calculateSizeAndPositionDataAndUpdateScrollOffset = _interopRequireDefault(
  require('./calculateSizeAndPositionDataAndUpdateScrollOffset'),
);
...
describe('calculateSizeAndPositionDataAndUpdateScrollOffset', function() {
  function helper() {
    var _ref =
      ...
      computeMetadataCallbackProps =
        _ref$computeMetadataC === void 0 ? {} : _ref$computeMetadataC,
      _ref$nextCellsCount = _ref.nextCellsCount,
      nextCellsCount =
        _ref$nextCellsCount === void 0 ? 100 : _ref$nextCellsCount,
  ...
  it('should not call :updateScrollOffsetForScrollToIndex if :scrollToIndex is not specified', function() {
    var _helper4 = helper(),
      updateScrollOffsetForScrollToIndexCalls =
        _helper4.updateScrollOffsetForScrollToIndexCalls;
  ...
  it('should not call :updateScrollOffsetForScrollToIndex if :scrollToIndex has also changed', function() {
    var _helper5 = helper({
      ...
      updateScrollOffsetForScrollToIndexCalls =
        _helper5.updateScrollOffsetForScrollToIndexCalls;
