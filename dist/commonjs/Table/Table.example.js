  ...
  (function(_React$PureComponent) {
    ...
    function TableExample(props, context) {
      ...
      _this = (0, _possibleConstructorReturn2['default'])(
        this,
        (0, _getPrototypeOf2['default'])(TableExample).call(
          this,
          props,
          context,
        ),
      ...
      _this._footerRenderer = _this._footerRenderer.bind(
        (0, _assertThisInitialized2['default'])(_this),
      );
      ...
      },
      {
        ...
        value: function _rowClassName(_ref7) {
          ...
          if (index < 0) {
            ...
            return index % 2 === 0
              ? _TableExample['default'].evenRow
              : _TableExample['default'].oddRow;
          }
        },
      },
      {
        ...
        value: function _sortList(_ref9) {
          ...
          return list
            ...
            .update(function(list) {
              return sortDirection === _SortDirection['default'].DESC
                ? list.reverse()
                : list;
            });
        },
