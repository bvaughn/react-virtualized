...
test(
  'save position after resize and then scroll in window',
...
test(
  'save position after resize and then scroll in container',
  /*#__PURE__*/ (0, _asyncToGenerator2['default'])(
...
test(
  'react on container resize without window changing',
  /*#__PURE__*/ (0, _asyncToGenerator2['default'])(
