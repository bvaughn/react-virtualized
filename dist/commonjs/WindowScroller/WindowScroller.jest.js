...
function getMarkup() {
  ...
  var windowScroller = /*#__PURE__*/ React.createElement(
...
describe('WindowScroller', function() {
  ...
  it(
    'should restore pointerEvents on body after IS_SCROLLING_TIMEOUT',
            ...
            switch ((_context.prev = _context.next)) {
              case 0:
                ...
                return new Promise(function(resolve) {
                  return setTimeout(
                    resolve,
                    _WindowScroller.IS_SCROLLING_TIMEOUT + 100,
                  );
                });
  ...
  describe('onScroll', function() {
    it(
      'should trigger callback when window scrolls',
      /*#__PURE__*/ (0, _asyncToGenerator2['default'])(
    ...
    it(
      'should update :scrollTop when window is scrolled',
      /*#__PURE__*/ (0, _asyncToGenerator2['default'])(
          ...
          return _regenerator['default'].wrap(function _callee3$(_context3) {
            while (1) {
              switch ((_context3.prev = _context3.next)) {
                ...
                case 6:
                  componentScrollTop =
                    window.scrollY - component._positionFromTop;
    ...
    it(
      'should specify :isScrolling when scrolling and reset after scrolling',
      /*#__PURE__*/ (0, _asyncToGenerator2['default'])(
