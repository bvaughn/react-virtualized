...
| rowStyle | Object or Function | | Optional custom inline style for individual row. If function given then signature should be look like: ({rowIndex: number, columnIndex: number}): PropTypes.object |
